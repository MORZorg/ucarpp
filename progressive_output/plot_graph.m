% Riccardo Orizio etc..
% 1 Giugno 2013
% Funzione che genera i grafici associati ad una soluzione ricevuta come
% parametro.

function plot_graph( nomefile )
    % Apro il file
    ...
    set( f, 'PaperPosition', 10 * [ 0, 0, 10, 5 ] );
    set( f, 'PaperSize', 10 * [ 10, 5 ] );
    ...
    saveas( f, strcat( nomefile, '.pdf' ), 'pdf' );

    % Informo l'utente di aver finito con la generazione del grafico
    fprintf( 'Creato il grafico di %s\n', nomefile );
end